...
vim.cmd(f("highlight TelescopePreviewNormal ctermbg=none"))
vim.cmd(f("highlight TelescopePreviewBorder ctermbg=none"))
vim.cmd(f("highlight TelescopeMatching ctermbg=none"))
vim.cmd(f("highlight TelescopeSelection ctermbg=none"))
vim.cmd(f("highlight TelescopeMultiSelection ctermbg=none"))
vim.cmd(f("highlight TelescopeMultiIcon ctermbg=none"))
...
vim.cmd(f("highlight DiffAdd guifg=none guibg={colors.red_150}"))
